    ...
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/80 backdrop-blur-xl">
      <div className="flex w-full items-center gap-3 px-4 py-2.5 lg:px-6">
          ...
          <div className="min-w-0 leading-tight">
            ...
            {fileName ? (
              <p className="flex items-center gap-1.5 truncate text-[11px] text-muted-foreground">
                ...
                <span className="hidden font-mono tabular-nums sm:inline">· {recordCount} records</span>
                <span className="hidden font-mono uppercase text-primary sm:inline">· {speedUnit}</span>
              </p>
            ) : (
        ...
        <div className="ml-auto flex items-center gap-2">
          <Button onClick={onLoadClick} variant="outline" size="sm">
